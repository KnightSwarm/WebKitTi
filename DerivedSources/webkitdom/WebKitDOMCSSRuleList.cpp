...
#define WEBKIT_DOM_CSS_RULE_LIST_GET_PRIVATE(obj) G_TYPE_INSTANCE_GET_PRIVATE(obj, WEBKIT_TYPE_DOM_CSS_RULE_LIST, WebKitDOMCSSRuleListPrivate)
...
{
    ASSERT(coreObject);
    return WEBKIT_DOM_CSS_RULE_LIST(g_object_new(WEBKIT_TYPE_DOM_CSS_RULE_LIST, "core-object", coreObject, NULL));
}
