...
{
    ASSERT(coreObject);
    return WEBKIT_DOM_KEYBOARD_EVENT(g_object_new(WEBKIT_TYPE_DOM_KEYBOARD_EVENT, "core-object", coreObject, NULL));
}

} // namespace WebKit

G_DEFINE_TYPE(WebKitDOMKeyboardEvent, webkit_dom_keyboard_event, WEBKIT_TYPE_DOM_UI_EVENT)
...
static void webkit_dom_keyboard_event_get_property(GObject* object, guint propertyId, GValue* value, GParamSpec* pspec)
{
    ...
    WebCore::KeyboardEvent* coreSelf = WebKit::core(self);

    switch (propertyId) {
    case PROP_KEY_IDENTIFIER: {
        g_value_take_string(value, convertToUTF8String(coreSelf->keyIdentifier()));
        break;
    }
    case PROP_KEY_LOCATION: {
        g_value_set_ulong(value, coreSelf->location());
        break;
    }
    case PROP_CTRL_KEY: {
    ...
    case PROP_ALT_GRAPH_KEY: {
        g_value_set_boolean(value, coreSelf->altGraphKey());
        break;
    }
    default:
...
static void webkit_dom_keyboard_event_class_init(WebKitDOMKeyboardEventClass* requestClass)
{
    ...
    g_object_class_install_property(gobjectClass,
                                    PROP_KEY_IDENTIFIER,
                                    g_param_spec_string("key-identifier", /* name */
                                                           "keyboard_event_key-identifier", /* short description */
                                                           "read-only  gchar* KeyboardEvent.key-identifier", /* longer - could do with some extra doc stuff here */
                                                           "", /* default */
                                                           WEBKIT_PARAM_READABLE));
    g_object_class_install_property(gobjectClass,
                                    PROP_KEY_LOCATION,
                                    g_param_spec_ulong("key-location", /* name */
                                                           "keyboard_event_key-location", /* short description */
                                                           "read-only  gulong KeyboardEvent.key-location", /* longer - could do with some extra doc stuff here */
                                                           0, /* min */
G_MAXULONG, /* max */
0, /* default */
                                                           WEBKIT_PARAM_READABLE));
    g_object_class_install_property(gobjectClass,
                                    ...
                                    g_param_spec_boolean("ctrl-key", /* name */
                                                           "keyboard_event_ctrl-key", /* short description */
                                                           "read-only  gboolean KeyboardEvent.ctrl-key", /* longer - could do with some extra doc stuff here */
                                                           FALSE, /* default */
                                                           WEBKIT_PARAM_READABLE));
    g_object_class_install_property(gobjectClass,
                                    PROP_SHIFT_KEY,
                                    g_param_spec_boolean("shift-key", /* name */
                                                           "keyboard_event_shift-key", /* short description */
                                                           "read-only  gboolean KeyboardEvent.shift-key", /* longer - could do with some extra doc stuff here */
                                                           FALSE, /* default */
                                                           WEBKIT_PARAM_READABLE));
    g_object_class_install_property(gobjectClass,
                                    PROP_ALT_KEY,
                                    g_param_spec_boolean("alt-key", /* name */
                                                           "keyboard_event_alt-key", /* short description */
                                                           "read-only  gboolean KeyboardEvent.alt-key", /* longer - could do with some extra doc stuff here */
                                                           FALSE, /* default */
                                                           WEBKIT_PARAM_READABLE));
    g_object_class_install_property(gobjectClass,
                                    PROP_META_KEY,
                                    g_param_spec_boolean("meta-key", /* name */
                                                           "keyboard_event_meta-key", /* short description */
                                                           "read-only  gboolean KeyboardEvent.meta-key", /* longer - could do with some extra doc stuff here */
                                                           FALSE, /* default */
                                                           WEBKIT_PARAM_READABLE));
    g_object_class_install_property(gobjectClass,
                                    PROP_ALT_GRAPH_KEY,
                                    g_param_spec_boolean("alt-graph-key", /* name */
                                                           "keyboard_event_alt-graph-key", /* short description */
                                                           "read-only  gboolean KeyboardEvent.alt-graph-key", /* longer - could do with some extra doc stuff here */
                                                           FALSE, /* default */
                                                           WEBKIT_PARAM_READABLE));
}
