...
#define WEBKIT_DOM_STYLE_SHEET_LIST_GET_PRIVATE(obj) G_TYPE_INSTANCE_GET_PRIVATE(obj, WEBKIT_TYPE_DOM_STYLE_SHEET_LIST, WebKitDOMStyleSheetListPrivate)
...
{
    ASSERT(coreObject);
    return WEBKIT_DOM_STYLE_SHEET_LIST(g_object_new(WEBKIT_TYPE_DOM_STYLE_SHEET_LIST, "core-object", coreObject, NULL));
}
