...
#define WEBKIT_DOM_BAR_PROP_GET_PRIVATE(obj) G_TYPE_INSTANCE_GET_PRIVATE(obj, WEBKIT_TYPE_DOM_BAR_PROP, WebKitDOMBarPropPrivate)
...
{
    ASSERT(coreObject);
    return WEBKIT_DOM_BAR_PROP(g_object_new(WEBKIT_TYPE_DOM_BAR_PROP, "core-object", coreObject, NULL));
}

} // namespace WebKit

G_DEFINE_TYPE(WebKitDOMBarProp, webkit_dom_bar_prop, WEBKIT_TYPE_DOM_OBJECT)
...
static void webkit_dom_bar_prop_get_property(GObject* object, guint propertyId, GValue* value, GParamSpec* pspec)
{
    ...
    WebCore::BarProp* coreSelf = WebKit::core(self);
...
static void webkit_dom_bar_prop_class_init(WebKitDOMBarPropClass* requestClass)
{
    ...
    g_object_class_install_property(gobjectClass,
                                    ...
                                    g_param_spec_boolean("visible", /* name */
                                                           "bar_prop_visible", /* short description */
                                                           "read-only  gboolean BarProp.visible", /* longer - could do with some extra doc stuff here */
                                                           FALSE, /* default */
