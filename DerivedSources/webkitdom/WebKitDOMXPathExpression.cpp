...
#define WEBKIT_DOM_XPATH_EXPRESSION_GET_PRIVATE(obj) G_TYPE_INSTANCE_GET_PRIVATE(obj, WEBKIT_TYPE_DOM_XPATH_EXPRESSION, WebKitDOMXPathExpressionPrivate)
...
{
    ASSERT(coreObject);
    return WEBKIT_DOM_XPATH_EXPRESSION(g_object_new(WEBKIT_TYPE_DOM_XPATH_EXPRESSION, "core-object", coreObject, NULL));
}
