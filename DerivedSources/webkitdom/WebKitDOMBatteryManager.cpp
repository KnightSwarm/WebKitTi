...
#define WEBKIT_DOM_BATTERY_MANAGER_GET_PRIVATE(obj) G_TYPE_INSTANCE_GET_PRIVATE(obj, WEBKIT_TYPE_DOM_BATTERY_MANAGER, WebKitDOMBatteryManagerPrivate)
...
{
    ASSERT(coreObject);
    return WEBKIT_DOM_BATTERY_MANAGER(g_object_new(WEBKIT_TYPE_DOM_BATTERY_MANAGER, "core-object", coreObject, NULL));
}
...
static void webkit_dom_battery_manager_dispatch_event(WebKitDOMEventTarget* target, WebKitDOMEvent* event, GError** error)
{
#if ENABLE(BATTERY_STATUS)
...
static gboolean webkit_dom_battery_manager_add_event_listener(WebKitDOMEventTarget* target, const char* eventName, GCallback handler, gboolean bubble, gpointer userData)
{
#if ENABLE(BATTERY_STATUS)
    WebCore::BatteryManager* coreTarget = static_cast<WebCore::BatteryManager*>(WEBKIT_DOM_OBJECT(target)->coreObject);
...
static gboolean webkit_dom_battery_manager_remove_event_listener(WebKitDOMEventTarget* target, const char* eventName, GCallback handler, gboolean bubble)
{
#if ENABLE(BATTERY_STATUS)
    WebCore::BatteryManager* coreTarget = static_cast<WebCore::BatteryManager*>(WEBKIT_DOM_OBJECT(target)->coreObject);
...
G_DEFINE_TYPE_WITH_CODE(WebKitDOMBatteryManager, webkit_dom_battery_manager, WEBKIT_TYPE_DOM_OBJECT, G_IMPLEMENT_INTERFACE(WEBKIT_TYPE_DOM_EVENT_TARGET, webkit_dom_event_target_init))
...
static void webkit_dom_battery_manager_get_property(GObject* object, guint propertyId, GValue* value, GParamSpec* pspec)
{
    ...
    WebCore::BatteryManager* coreSelf = WebKit::core(self);
#endif // ENABLE(BATTERY_STATUS)
    switch (propertyId) {
    case PROP_CHARGING: {
#if ENABLE(BATTERY_STATUS)
        g_value_set_boolean(value, coreSelf->charging());
#else
        WEBKIT_WARN_FEATURE_NOT_PRESENT("Battery Status")
#endif /* ENABLE(BATTERY_STATUS) */
        break;
...
#if ENABLE(BATTERY_STATUS)
        g_value_set_double(value, coreSelf->chargingTime());
#else
        WEBKIT_WARN_FEATURE_NOT_PRESENT("Battery Status")
#endif /* ENABLE(BATTERY_STATUS) */
        break;
...
#if ENABLE(BATTERY_STATUS)
        g_value_set_double(value, coreSelf->dischargingTime());
#else
        WEBKIT_WARN_FEATURE_NOT_PRESENT("Battery Status")
#endif /* ENABLE(BATTERY_STATUS) */
        break;
    ...
    case PROP_LEVEL: {
#if ENABLE(BATTERY_STATUS)
        g_value_set_double(value, coreSelf->level());
#else
        WEBKIT_WARN_FEATURE_NOT_PRESENT("Battery Status")
#endif /* ENABLE(BATTERY_STATUS) */
        break;
...
static void webkit_dom_battery_manager_class_init(WebKitDOMBatteryManagerClass* requestClass)
{
    ...
    g_object_class_install_property(gobjectClass,
                                    PROP_CHARGING,
                                    g_param_spec_boolean("charging", /* name */
                                                           "battery_manager_charging", /* short description */
                                                           "read-only  gboolean BatteryManager.charging", /* longer - could do with some extra doc stuff here */
                                                           FALSE, /* default */
                                                           WEBKIT_PARAM_READABLE));
    g_object_class_install_property(gobjectClass,
                                    PROP_CHARGING_TIME,
                                    g_param_spec_double("charging-time", /* name */
                                                           "battery_manager_charging-time", /* short description */
                                                           "read-only  gdouble BatteryManager.charging-time", /* longer - could do with some extra doc stuff here */
                                                           -G_MAXDOUBLE, /* min */
G_MAXDOUBLE, /* max */
0.0, /* default */
                                                           WEBKIT_PARAM_READABLE));
    g_object_class_install_property(gobjectClass,
                                    PROP_DISCHARGING_TIME,
                                    g_param_spec_double("discharging-time", /* name */
                                                           "battery_manager_discharging-time", /* short description */
                                                           "read-only  gdouble BatteryManager.discharging-time", /* longer - could do with some extra doc stuff here */
                                                           -G_MAXDOUBLE, /* min */
G_MAXDOUBLE, /* max */
0.0, /* default */
                                                           WEBKIT_PARAM_READABLE));
    g_object_class_install_property(gobjectClass,
                                    PROP_LEVEL,
                                    g_param_spec_double("level", /* name */
                                                           "battery_manager_level", /* short description */
                                                           "read-only  gdouble BatteryManager.level", /* longer - could do with some extra doc stuff here */
                                                           -G_MAXDOUBLE, /* min */
G_MAXDOUBLE, /* max */
0.0, /* default */
                                                           WEBKIT_PARAM_READABLE));
