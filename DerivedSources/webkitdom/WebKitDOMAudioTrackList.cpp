...
#define WEBKIT_DOM_AUDIO_TRACK_LIST_GET_PRIVATE(obj) G_TYPE_INSTANCE_GET_PRIVATE(obj, WEBKIT_TYPE_DOM_AUDIO_TRACK_LIST, WebKitDOMAudioTrackListPrivate)
...
{
    ASSERT(coreObject);
    return WEBKIT_DOM_AUDIO_TRACK_LIST(g_object_new(WEBKIT_TYPE_DOM_AUDIO_TRACK_LIST, "core-object", coreObject, NULL));
}
...
static void webkit_dom_audio_track_list_dispatch_event(WebKitDOMEventTarget* target, WebKitDOMEvent* event, GError** error)
{
#if ENABLE(VIDEO_TRACK)
...
static gboolean webkit_dom_audio_track_list_add_event_listener(WebKitDOMEventTarget* target, const char* eventName, GCallback handler, gboolean bubble, gpointer userData)
{
#if ENABLE(VIDEO_TRACK)
    WebCore::AudioTrackList* coreTarget = static_cast<WebCore::AudioTrackList*>(WEBKIT_DOM_OBJECT(target)->coreObject);
...
static gboolean webkit_dom_audio_track_list_remove_event_listener(WebKitDOMEventTarget* target, const char* eventName, GCallback handler, gboolean bubble)
{
#if ENABLE(VIDEO_TRACK)
    WebCore::AudioTrackList* coreTarget = static_cast<WebCore::AudioTrackList*>(WEBKIT_DOM_OBJECT(target)->coreObject);
...
G_DEFINE_TYPE_WITH_CODE(WebKitDOMAudioTrackList, webkit_dom_audio_track_list, WEBKIT_TYPE_DOM_OBJECT, G_IMPLEMENT_INTERFACE(WEBKIT_TYPE_DOM_EVENT_TARGET, webkit_dom_event_target_init))
...
static void webkit_dom_audio_track_list_get_property(GObject* object, guint propertyId, GValue* value, GParamSpec* pspec)
{
    ...
    WebCore::AudioTrackList* coreSelf = WebKit::core(self);
#endif // ENABLE(VIDEO_TRACK)
    switch (propertyId) {
    case PROP_LENGTH: {
#if ENABLE(VIDEO_TRACK)
...
static void webkit_dom_audio_track_list_class_init(WebKitDOMAudioTrackListClass* requestClass)
{
    ...
    g_object_class_install_property(gobjectClass,
                                    ...
                                    g_param_spec_ulong("length", /* name */
                                                           "audio_track_list_length", /* short description */
                                                           "read-only  gulong AudioTrackList.length", /* longer - could do with some extra doc stuff here */
                                                           0, /* min */
G_MAXULONG, /* max */
0, /* default */
...
#if ENABLE(VIDEO_TRACK)
    WebCore::JSMainThreadNullState state;
    g_return_val_if_fail(WEBKIT_DOM_IS_AUDIO_TRACK_LIST(self), FALSE);
