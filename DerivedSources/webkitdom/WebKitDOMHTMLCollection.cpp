...
#define WEBKIT_DOM_HTML_COLLECTION_GET_PRIVATE(obj) G_TYPE_INSTANCE_GET_PRIVATE(obj, WEBKIT_TYPE_DOM_HTML_COLLECTION, WebKitDOMHTMLCollectionPrivate)
...
{
    ASSERT(coreObject);
    return WEBKIT_DOM_HTML_COLLECTION(g_object_new(WEBKIT_TYPE_DOM_HTML_COLLECTION, "core-object", coreObject, NULL));
}
