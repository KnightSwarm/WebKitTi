...
#define WEBKIT_DOM_BLOB_GET_PRIVATE(obj) G_TYPE_INSTANCE_GET_PRIVATE(obj, WEBKIT_TYPE_DOM_BLOB, WebKitDOMBlobPrivate)
...
{
    ASSERT(coreObject);
    return WEBKIT_DOM_BLOB(g_object_new(WEBKIT_TYPE_DOM_BLOB, "core-object", coreObject, NULL));
}
