...
#define WEBKIT_DOM_VIDEO_TRACK_GET_PRIVATE(obj) G_TYPE_INSTANCE_GET_PRIVATE(obj, WEBKIT_TYPE_DOM_VIDEO_TRACK, WebKitDOMVideoTrackPrivate)
...
{
    ASSERT(coreObject);
    return WEBKIT_DOM_VIDEO_TRACK(g_object_new(WEBKIT_TYPE_DOM_VIDEO_TRACK, "core-object", coreObject, NULL));
}
...
G_DEFINE_TYPE(WebKitDOMVideoTrack, webkit_dom_video_track, WEBKIT_TYPE_DOM_OBJECT)
...
static void webkit_dom_video_track_set_property(GObject* object, guint propertyId, const GValue* value, GParamSpec* pspec)
{
    ...
    WebCore::VideoTrack* coreSelf = WebKit::core(self);
#endif // ENABLE(VIDEO_TRACK)
    switch (propertyId) {
    case PROP_SELECTED: {
#if ENABLE(VIDEO_TRACK)
...
static void webkit_dom_video_track_class_init(WebKitDOMVideoTrackClass* requestClass)
{
    ...
    g_object_class_install_property(gobjectClass,
                                    ...
                                    g_param_spec_string("id", /* name */
                                                           "video_track_id", /* short description */
                                                           "read-only  gchar* VideoTrack.id", /* longer - could do with some extra doc stuff here */
                                                           "", /* default */
                                                           WEBKIT_PARAM_READABLE));
    g_object_class_install_property(gobjectClass,
                                    PROP_KIND,
                                    g_param_spec_string("kind", /* name */
                                                           "video_track_kind", /* short description */
                                                           "read-only  gchar* VideoTrack.kind", /* longer - could do with some extra doc stuff here */
                                                           "", /* default */
                                                           WEBKIT_PARAM_READABLE));
    g_object_class_install_property(gobjectClass,
                                    PROP_LABEL,
                                    g_param_spec_string("label", /* name */
                                                           "video_track_label", /* short description */
                                                           "read-only  gchar* VideoTrack.label", /* longer - could do with some extra doc stuff here */
                                                           "", /* default */
                                                           WEBKIT_PARAM_READABLE));
    g_object_class_install_property(gobjectClass,
                                    PROP_LANGUAGE,
                                    g_param_spec_string("language", /* name */
                                                           "video_track_language", /* short description */
                                                           "read-only  gchar* VideoTrack.language", /* longer - could do with some extra doc stuff here */
                                                           "", /* default */
                                                           WEBKIT_PARAM_READABLE));
    g_object_class_install_property(gobjectClass,
                                    PROP_SELECTED,
                                    g_param_spec_boolean("selected", /* name */
                                                           "video_track_selected", /* short description */
                                                           "read-write  gboolean VideoTrack.selected", /* longer - could do with some extra doc stuff here */
                                                           FALSE, /* default */
