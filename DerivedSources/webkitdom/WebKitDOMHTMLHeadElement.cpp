...
{
    ASSERT(coreObject);
    return WEBKIT_DOM_HTML_HEAD_ELEMENT(g_object_new(WEBKIT_TYPE_DOM_HTML_HEAD_ELEMENT, "core-object", coreObject, NULL));
}
...
static void webkit_dom_html_head_element_get_property(GObject* object, guint propertyId, GValue* value, GParamSpec* pspec)
{
    ...
    switch (propertyId) {
    case PROP_PROFILE: {
        g_value_take_string(value, convertToUTF8String(coreSelf->fastGetAttribute(WebCore::HTMLNames::profileAttr)));
        break;
    }
    default:
        G_OBJECT_WARN_INVALID_PROPERTY_ID(object, propertyId, pspec);
...
webkit_dom_html_head_element_get_profile(WebKitDOMHTMLHeadElement* self)
{
    ...
    gchar* result = convertToUTF8String(item->fastGetAttribute(WebCore::HTMLNames::profileAttr));
    return result;
}
...
webkit_dom_html_head_element_set_profile(WebKitDOMHTMLHeadElement* self, const gchar* value)
{
    ...
    item->setAttribute(WebCore::HTMLNames::profileAttr, convertedValue);
}
