...
static const GFlagsValue _webkit_security_policy_values[] = {
    { WEBKIT_SECURITY_POLICY_LOCAL, "WEBKIT_SECURITY_POLICY_LOCAL", "local" },
    { WEBKIT_SECURITY_POLICY_NO_ACCESS_TO_OTHER_SCHEME, "WEBKIT_SECURITY_POLICY_NO_ACCESS_TO_OTHER_SCHEME", "no-access-to-other-scheme" },
    { WEBKIT_SECURITY_POLICY_DISPLAY_ISOLATED, "WEBKIT_SECURITY_POLICY_DISPLAY_ISOLATED", "display-isolated" },
    { WEBKIT_SECURITY_POLICY_SECURE, "WEBKIT_SECURITY_POLICY_SECURE", "secure" },
    { WEBKIT_SECURITY_POLICY_CORS_ENABLED, "WEBKIT_SECURITY_POLICY_CORS_ENABLED", "cors-enabled" },
    { WEBKIT_SECURITY_POLICY_EMPTY_DOCUMENT, "WEBKIT_SECURITY_POLICY_EMPTY_DOCUMENT", "empty-document" },
    { 0, NULL, NULL }
};

GType webkit_security_policy_get_type(void)
{
    static GType type = 0;

    if (!type)
        type = g_flags_register_static("WebKitSecurityPolicy", _webkit_security_policy_values);
