...
{
    return JSSVGFilterElementPrototype::create(exec->vm(), globalObject, JSSVGFilterElementPrototype::createStructure(exec->vm(), globalObject, JSSVGElementPrototype::self(exec, globalObject)));
}
