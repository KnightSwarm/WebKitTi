...
public:
    ...
    static JSRTCIceCandidateConstructor* create(JSC::ExecState* exec, JSC::Structure* structure, JSDOMGlobalObject* globalObject)
    {
        JSRTCIceCandidateConstructor* ptr = new (NotNull, JSC::allocateCell<JSRTCIceCandidateConstructor>(*exec->heap())) JSRTCIceCandidateConstructor(structure, globalObject);
