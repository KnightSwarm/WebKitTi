...
{
    return JSSVGFEComponentTransferElementPrototype::create(exec->vm(), globalObject, JSSVGFEComponentTransferElementPrototype::createStructure(exec->vm(), globalObject, JSSVGElementPrototype::self(exec, globalObject)));
}
