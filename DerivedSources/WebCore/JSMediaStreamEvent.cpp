...
void JSMediaStreamEventConstructor::finishCreation(ExecState* exec, JSDOMGlobalObject* globalObject)
{
    ...
    putDirect(exec->vm(), exec->propertyNames().prototype, JSMediaStreamEventPrototype::self(exec, globalObject), DontDelete | ReadOnly);
...
{
    return JSMediaStreamEventPrototype::create(exec->vm(), globalObject, JSMediaStreamEventPrototype::createStructure(exec->vm(), globalObject, JSEventPrototype::self(exec, globalObject)));
}
...
{
    return getDOMConstructor<JSMediaStreamEventConstructor>(exec, jsCast<JSDOMGlobalObject*>(globalObject));
}
