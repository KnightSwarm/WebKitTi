...
bool JSPerformanceEntryConstructor::getOwnPropertySlot(JSObject* object, ExecState* exec, PropertyName propertyName, PropertySlot& slot)
{
    return getStaticValueSlot<JSPerformanceEntryConstructor, JSDOMWrapper>(exec, &JSPerformanceEntryConstructorTable, jsCast<JSPerformanceEntryConstructor*>(object), propertyName, slot);
}
...
bool JSPerformanceEntry::getOwnPropertySlot(JSObject* object, ExecState* exec, PropertyName propertyName, PropertySlot& slot)
{
...
{
    return value.inherits(JSPerformanceEntry::info()) ? jsCast<JSPerformanceEntry*>(asObject(value))->impl() : 0;
}
