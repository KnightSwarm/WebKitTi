...
{
    return JSSVGMissingGlyphElementPrototype::create(exec->vm(), globalObject, JSSVGMissingGlyphElementPrototype::createStructure(exec->vm(), globalObject, JSSVGElementPrototype::self(exec, globalObject)));
}
