...
bool JSGamepad::getOwnPropertySlot(JSObject* object, ExecState* exec, PropertyName propertyName, PropertySlot& slot)
{
...
{
    return value.inherits(JSGamepad::info()) ? jsCast<JSGamepad*>(asObject(value))->impl() : 0;
}
