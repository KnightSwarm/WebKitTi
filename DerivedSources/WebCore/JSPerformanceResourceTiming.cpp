...
bool JSPerformanceResourceTimingConstructor::getOwnPropertySlot(JSObject* object, ExecState* exec, PropertyName propertyName, PropertySlot& slot)
{
    return getStaticValueSlot<JSPerformanceResourceTimingConstructor, JSDOMWrapper>(exec, &JSPerformanceResourceTimingConstructorTable, jsCast<JSPerformanceResourceTimingConstructor*>(object), propertyName, slot);
}
...
bool JSPerformanceResourceTiming::getOwnPropertySlot(JSObject* object, ExecState* exec, PropertyName propertyName, PropertySlot& slot)
{
