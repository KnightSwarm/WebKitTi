...
{
    return JSSVGGraphicsElementPrototype::create(exec->vm(), globalObject, JSSVGGraphicsElementPrototype::createStructure(exec->vm(), globalObject, JSSVGElementPrototype::self(exec, globalObject)));
}
