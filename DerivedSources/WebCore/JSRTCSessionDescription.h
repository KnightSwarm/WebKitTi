...
public:
    ...
    static JSRTCSessionDescriptionConstructor* create(JSC::ExecState* exec, JSC::Structure* structure, JSDOMGlobalObject* globalObject)
    {
        JSRTCSessionDescriptionConstructor* ptr = new (NotNull, JSC::allocateCell<JSRTCSessionDescriptionConstructor>(*exec->heap())) JSRTCSessionDescriptionConstructor(structure, globalObject);
