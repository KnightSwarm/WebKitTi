...
public:
    ...
    static JSRTCPeerConnectionConstructor* create(JSC::ExecState* exec, JSC::Structure* structure, JSDOMGlobalObject* globalObject)
    {
        JSRTCPeerConnectionConstructor* ptr = new (NotNull, JSC::allocateCell<JSRTCPeerConnectionConstructor>(*exec->heap())) JSRTCPeerConnectionConstructor(structure, globalObject);
