...
{
    return JSSVGMaskElementPrototype::create(exec->vm(), globalObject, JSSVGMaskElementPrototype::createStructure(exec->vm(), globalObject, JSSVGElementPrototype::self(exec, globalObject)));
}
