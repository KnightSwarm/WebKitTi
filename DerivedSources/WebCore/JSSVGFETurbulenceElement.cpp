...
{
    return JSSVGFETurbulenceElementPrototype::create(exec->vm(), globalObject, JSSVGFETurbulenceElementPrototype::createStructure(exec->vm(), globalObject, JSSVGElementPrototype::self(exec, globalObject)));
}
