...
{
    return JSSVGFEDiffuseLightingElementPrototype::create(exec->vm(), globalObject, JSSVGFEDiffuseLightingElementPrototype::createStructure(exec->vm(), globalObject, JSSVGElementPrototype::self(exec, globalObject)));
}
