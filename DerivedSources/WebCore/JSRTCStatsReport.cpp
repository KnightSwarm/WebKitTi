...
{
    { "timestamp", DontDelete | ReadOnly, (intptr_t)static_cast<PropertySlot::GetValueFunc>(jsRTCStatsReportTimestamp), (intptr_t)0, NoIntrinsic },
    { "id", DontDelete | ReadOnly, (intptr_t)static_cast<PropertySlot::GetValueFunc>(jsRTCStatsReportId), (intptr_t)0, NoIntrinsic },
    { "type", DontDelete | ReadOnly, (intptr_t)static_cast<PropertySlot::GetValueFunc>(jsRTCStatsReportType), (intptr_t)0, NoIntrinsic },
    { "local", DontDelete | ReadOnly, (intptr_t)static_cast<PropertySlot::GetValueFunc>(jsRTCStatsReportLocal), (intptr_t)0, NoIntrinsic },
    { "remote", DontDelete | ReadOnly, (intptr_t)static_cast<PropertySlot::GetValueFunc>(jsRTCStatsReportRemote), (intptr_t)0, NoIntrinsic },
    { 0, 0, 0, 0, NoIntrinsic }
};
...
{
    { "stat", DontDelete | JSC::Function, (intptr_t)static_cast<NativeFunction>(jsRTCStatsReportPrototypeFunctionStat), (intptr_t)1, NoIntrinsic },
    { "names", DontDelete | JSC::Function, (intptr_t)static_cast<NativeFunction>(jsRTCStatsReportPrototypeFunctionNames), (intptr_t)0, NoIntrinsic },
    { 0, 0, 0, 0, NoIntrinsic }
};
...
JSObject* JSRTCStatsReportPrototype::self(ExecState* exec, JSGlobalObject* globalObject)
{
    return getDOMPrototype<JSRTCStatsReport>(exec, globalObject);
}
...
JSObject* JSRTCStatsReport::createPrototype(ExecState* exec, JSGlobalObject* globalObject)
{
    return JSRTCStatsReportPrototype::create(exec->vm(), globalObject, JSRTCStatsReportPrototype::createStructure(globalObject->vm(), globalObject, globalObject->objectPrototype()));
}
...
JSValue jsRTCStatsReportTimestamp(ExecState* exec, JSValue slotBase, PropertyName)
{
    ...
    UNUSED_PARAM(exec);
    RTCStatsReport* impl = static_cast<RTCStatsReport*>(castedThis->impl());
