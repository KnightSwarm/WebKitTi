...
bool JSHTMLContentElementConstructor::getOwnPropertySlot(JSObject* object, ExecState* exec, PropertyName propertyName, PropertySlot& slot)
{
    return getStaticValueSlot<JSHTMLContentElementConstructor, JSDOMWrapper>(exec, &JSHTMLContentElementConstructorTable, jsCast<JSHTMLContentElementConstructor*>(object), propertyName, slot);
}
...
bool JSHTMLContentElement::getOwnPropertySlot(JSObject* object, ExecState* exec, PropertyName propertyName, PropertySlot& slot)
{
