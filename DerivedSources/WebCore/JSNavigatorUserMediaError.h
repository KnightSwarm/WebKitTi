...
JSC::JSValue jsNavigatorUserMediaErrorCode(JSC::ExecState*, JSC::JSValue, JSC::PropertyName);
// Constants

JSC::JSValue jsNavigatorUserMediaErrorPERMISSION_DENIED(JSC::ExecState*, JSC::JSValue, JSC::PropertyName);
