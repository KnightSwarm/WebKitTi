...
{
    return JSSVGMarkerElementPrototype::create(exec->vm(), globalObject, JSSVGMarkerElementPrototype::createStructure(exec->vm(), globalObject, JSSVGElementPrototype::self(exec, globalObject)));
}
