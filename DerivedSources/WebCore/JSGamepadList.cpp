...
bool JSGamepadListPrototype::getOwnPropertySlot(JSObject* object, ExecState* exec, PropertyName propertyName, PropertySlot& slot)
{
...
bool JSGamepadList::getOwnPropertySlot(JSObject* object, ExecState* exec, PropertyName propertyName, PropertySlot& slot)
{
...
bool JSGamepadList::getOwnPropertySlotByIndex(JSObject* object, ExecState* exec, unsigned index, PropertySlot& slot)
{
    JSGamepadList* thisObject = jsCast<JSGamepadList*>(object);
    ASSERT_GC_OBJECT_INHERITS(thisObject, info());
...
EncodedJSValue JSC_HOST_CALL jsGamepadListPrototypeFunctionItem(ExecState* exec)
{
    ...
    if (!thisValue.inherits(JSGamepadList::info()))
...
{
    return value.inherits(JSGamepadList::info()) ? jsCast<JSGamepadList*>(asObject(value))->impl() : 0;
}
