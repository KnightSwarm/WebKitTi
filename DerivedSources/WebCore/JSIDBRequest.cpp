...
bool JSIDBRequestPrototype::getOwnPropertySlot(JSObject* object, ExecState* exec, PropertyName propertyName, PropertySlot& slot)
{
...
EncodedJSValue JSC_HOST_CALL jsIDBRequestPrototypeFunctionAddEventListener(ExecState* exec)
{
    ...
    if (!thisValue.inherits(JSIDBRequest::info()))
        return throwVMTypeError(exec);
    JSIDBRequest* castedThis = jsCast<JSIDBRequest*>(asObject(thisValue));
    ASSERT_GC_OBJECT_INHERITS(castedThis, JSIDBRequest::info());
    IDBRequest* impl = static_cast<IDBRequest*>(castedThis->impl());
