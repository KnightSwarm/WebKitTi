...
{
    { "label", DontDelete | ReadOnly, (intptr_t)static_cast<PropertySlot::GetValueFunc>(jsRTCDataChannelLabel), (intptr_t)0, NoIntrinsic },
    { "reliable", DontDelete | ReadOnly, (intptr_t)static_cast<PropertySlot::GetValueFunc>(jsRTCDataChannelReliable), (intptr_t)0, NoIntrinsic },
    { "readyState", DontDelete | ReadOnly, (intptr_t)static_cast<PropertySlot::GetValueFunc>(jsRTCDataChannelReadyState), (intptr_t)0, NoIntrinsic },
    { "bufferedAmount", DontDelete | ReadOnly, (intptr_t)static_cast<PropertySlot::GetValueFunc>(jsRTCDataChannelBufferedAmount), (intptr_t)0, NoIntrinsic },
    { "binaryType", DontDelete, (intptr_t)static_cast<PropertySlot::GetValueFunc>(jsRTCDataChannelBinaryType), (intptr_t)setJSRTCDataChannelBinaryType, NoIntrinsic },
    { "onopen", DontDelete, (intptr_t)static_cast<PropertySlot::GetValueFunc>(jsRTCDataChannelOnopen), (intptr_t)setJSRTCDataChannelOnopen, NoIntrinsic },
    { "onerror", DontDelete, (intptr_t)static_cast<PropertySlot::GetValueFunc>(jsRTCDataChannelOnerror), (intptr_t)setJSRTCDataChannelOnerror, NoIntrinsic },
    { "onclose", DontDelete, (intptr_t)static_cast<PropertySlot::GetValueFunc>(jsRTCDataChannelOnclose), (intptr_t)setJSRTCDataChannelOnclose, NoIntrinsic },
    { "onmessage", DontDelete, (intptr_t)static_cast<PropertySlot::GetValueFunc>(jsRTCDataChannelOnmessage), (intptr_t)setJSRTCDataChannelOnmessage, NoIntrinsic },
    { 0, 0, 0, 0, NoIntrinsic }
};

static const HashTable JSRTCDataChannelTable = { 33, 31, JSRTCDataChannelTableValues, 0 };
/* Hash table for prototype */

static const HashTableValue JSRTCDataChannelPrototypeTableValues[] =
{
    { "send", DontDelete | JSC::Function, (intptr_t)static_cast<NativeFunction>(jsRTCDataChannelPrototypeFunctionSend), (intptr_t)1, NoIntrinsic },
    { "close", DontDelete | JSC::Function, (intptr_t)static_cast<NativeFunction>(jsRTCDataChannelPrototypeFunctionClose), (intptr_t)0, NoIntrinsic },
    { "addEventListener", DontDelete | JSC::Function, (intptr_t)static_cast<NativeFunction>(jsRTCDataChannelPrototypeFunctionAddEventListener), (intptr_t)2, NoIntrinsic },
    { "removeEventListener", DontDelete | JSC::Function, (intptr_t)static_cast<NativeFunction>(jsRTCDataChannelPrototypeFunctionRemoveEventListener), (intptr_t)2, NoIntrinsic },
    { "dispatchEvent", DontDelete | JSC::Function, (intptr_t)static_cast<NativeFunction>(jsRTCDataChannelPrototypeFunctionDispatchEvent), (intptr_t)1, NoIntrinsic },
    { 0, 0, 0, 0, NoIntrinsic }
};
...
JSObject* JSRTCDataChannelPrototype::self(ExecState* exec, JSGlobalObject* globalObject)
{
    return getDOMPrototype<JSRTCDataChannel>(exec, globalObject);
}
...
JSObject* JSRTCDataChannel::createPrototype(ExecState* exec, JSGlobalObject* globalObject)
{
    return JSRTCDataChannelPrototype::create(exec->vm(), globalObject, JSRTCDataChannelPrototype::createStructure(globalObject->vm(), globalObject, globalObject->objectPrototype()));
}
...
JSValue jsRTCDataChannelLabel(ExecState* exec, JSValue slotBase, PropertyName)
{
    ...
    UNUSED_PARAM(exec);
    RTCDataChannel* impl = static_cast<RTCDataChannel*>(castedThis->impl());
    JSValue result = jsStringWithCache(exec, impl->label());
    return result;
}


JSValue jsRTCDataChannelReliable(ExecState* exec, JSValue slotBase, PropertyName)
{
    JSRTCDataChannel* castedThis = jsCast<JSRTCDataChannel*>(asObject(slotBase));
    UNUSED_PARAM(exec);
    RTCDataChannel* impl = static_cast<RTCDataChannel*>(castedThis->impl());
    JSValue result = jsBoolean(impl->reliable());
    return result;
}
