...
{
    return JSSVGFETileElementPrototype::create(exec->vm(), globalObject, JSSVGFETileElementPrototype::createStructure(exec->vm(), globalObject, JSSVGElementPrototype::self(exec, globalObject)));
}
