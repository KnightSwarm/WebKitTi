...
{
    { "canInsertDTMF", DontDelete | ReadOnly, (intptr_t)static_cast<PropertySlot::GetValueFunc>(jsRTCDTMFSenderCanInsertDTMF), (intptr_t)0, NoIntrinsic },
    { "track", DontDelete | ReadOnly, (intptr_t)static_cast<PropertySlot::GetValueFunc>(jsRTCDTMFSenderTrack), (intptr_t)0, NoIntrinsic },
    { "toneBuffer", DontDelete | ReadOnly, (intptr_t)static_cast<PropertySlot::GetValueFunc>(jsRTCDTMFSenderToneBuffer), (intptr_t)0, NoIntrinsic },
    { "duration", DontDelete | ReadOnly, (intptr_t)static_cast<PropertySlot::GetValueFunc>(jsRTCDTMFSenderDuration), (intptr_t)0, NoIntrinsic },
    { "interToneGap", DontDelete | ReadOnly, (intptr_t)static_cast<PropertySlot::GetValueFunc>(jsRTCDTMFSenderInterToneGap), (intptr_t)0, NoIntrinsic },
    { "ontonechange", DontDelete, (intptr_t)static_cast<PropertySlot::GetValueFunc>(jsRTCDTMFSenderOntonechange), (intptr_t)setJSRTCDTMFSenderOntonechange, NoIntrinsic },
    { 0, 0, 0, 0, NoIntrinsic }
};
...
{
    { "insertDTMF", DontDelete | JSC::Function, (intptr_t)static_cast<NativeFunction>(jsRTCDTMFSenderPrototypeFunctionInsertDTMF), (intptr_t)1, NoIntrinsic },
    { "addEventListener", DontDelete | JSC::Function, (intptr_t)static_cast<NativeFunction>(jsRTCDTMFSenderPrototypeFunctionAddEventListener), (intptr_t)2, NoIntrinsic },
    { "removeEventListener", DontDelete | JSC::Function, (intptr_t)static_cast<NativeFunction>(jsRTCDTMFSenderPrototypeFunctionRemoveEventListener), (intptr_t)2, NoIntrinsic },
    { "dispatchEvent", DontDelete | JSC::Function, (intptr_t)static_cast<NativeFunction>(jsRTCDTMFSenderPrototypeFunctionDispatchEvent), (intptr_t)1, NoIntrinsic },
    { 0, 0, 0, 0, NoIntrinsic }
};
...
JSObject* JSRTCDTMFSenderPrototype::self(ExecState* exec, JSGlobalObject* globalObject)
{
    return getDOMPrototype<JSRTCDTMFSender>(exec, globalObject);
}
...
JSObject* JSRTCDTMFSender::createPrototype(ExecState* exec, JSGlobalObject* globalObject)
{
    return JSRTCDTMFSenderPrototype::create(exec->vm(), globalObject, JSRTCDTMFSenderPrototype::createStructure(globalObject->vm(), globalObject, globalObject->objectPrototype()));
}
...
JSValue jsRTCDTMFSenderCanInsertDTMF(ExecState* exec, JSValue slotBase, PropertyName)
{
    ...
    UNUSED_PARAM(exec);
    RTCDTMFSender* impl = static_cast<RTCDTMFSender*>(castedThis->impl());
