...
bool JSDOMFileSystemSync::getOwnPropertySlot(JSObject* object, ExecState* exec, PropertyName propertyName, PropertySlot& slot)
{
...
{
    return value.inherits(JSDOMFileSystemSync::info()) ? jsCast<JSDOMFileSystemSync*>(asObject(value))->impl() : 0;
}
