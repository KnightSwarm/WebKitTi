...
{
    return JSSVGFESpecularLightingElementPrototype::create(exec->vm(), globalObject, JSSVGFESpecularLightingElementPrototype::createStructure(exec->vm(), globalObject, JSSVGElementPrototype::self(exec, globalObject)));
}
