...
bool JSEntryArrayPrototype::getOwnPropertySlot(JSObject* object, ExecState* exec, PropertyName propertyName, PropertySlot& slot)
{
...
bool JSEntryArray::getOwnPropertySlot(JSObject* object, ExecState* exec, PropertyName propertyName, PropertySlot& slot)
{
...
bool JSEntryArray::getOwnPropertySlotByIndex(JSObject* object, ExecState* exec, unsigned index, PropertySlot& slot)
{
    JSEntryArray* thisObject = jsCast<JSEntryArray*>(object);
    ASSERT_GC_OBJECT_INHERITS(thisObject, info());
...
EncodedJSValue JSC_HOST_CALL jsEntryArrayPrototypeFunctionItem(ExecState* exec)
{
    ...
    if (!thisValue.inherits(JSEntryArray::info()))
        return throwVMTypeError(exec);
    JSEntryArray* castedThis = jsCast<JSEntryArray*>(asObject(thisValue));
    ASSERT_GC_OBJECT_INHERITS(castedThis, JSEntryArray::info());
    EntryArray* impl = static_cast<EntryArray*>(castedThis->impl());
...
{
    return value.inherits(JSEntryArray::info()) ? jsCast<JSEntryArray*>(asObject(value))->impl() : 0;
}
