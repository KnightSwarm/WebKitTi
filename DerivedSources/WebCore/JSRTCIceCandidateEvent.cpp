...
{
    { "candidate", DontDelete | ReadOnly, (intptr_t)static_cast<PropertySlot::GetValueFunc>(jsRTCIceCandidateEventCandidate), (intptr_t)0, NoIntrinsic },
    { 0, 0, 0, 0, NoIntrinsic }
};
...
JSObject* JSRTCIceCandidateEventPrototype::self(ExecState* exec, JSGlobalObject* globalObject)
{
    return getDOMPrototype<JSRTCIceCandidateEvent>(exec, globalObject);
}
...
JSObject* JSRTCIceCandidateEvent::createPrototype(ExecState* exec, JSGlobalObject* globalObject)
{
    return JSRTCIceCandidateEventPrototype::create(exec->vm(), globalObject, JSRTCIceCandidateEventPrototype::createStructure(exec->vm(), globalObject, JSEventPrototype::self(exec, globalObject)));
}
...
JSValue jsRTCIceCandidateEventCandidate(ExecState* exec, JSValue slotBase, PropertyName)
{
    ...
    UNUSED_PARAM(exec);
    RTCIceCandidateEvent* impl = static_cast<RTCIceCandidateEvent*>(castedThis->impl());
