...
{
    return JSSVGFEOffsetElementPrototype::create(exec->vm(), globalObject, JSSVGFEOffsetElementPrototype::createStructure(exec->vm(), globalObject, JSSVGElementPrototype::self(exec, globalObject)));
}
