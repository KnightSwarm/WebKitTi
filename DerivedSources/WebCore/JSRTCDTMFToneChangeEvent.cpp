...
{
    { "tone", DontDelete | ReadOnly, (intptr_t)static_cast<PropertySlot::GetValueFunc>(jsRTCDTMFToneChangeEventTone), (intptr_t)0, NoIntrinsic },
    { 0, 0, 0, 0, NoIntrinsic }
};
...
JSObject* JSRTCDTMFToneChangeEventPrototype::self(ExecState* exec, JSGlobalObject* globalObject)
{
    return getDOMPrototype<JSRTCDTMFToneChangeEvent>(exec, globalObject);
}
...
JSObject* JSRTCDTMFToneChangeEvent::createPrototype(ExecState* exec, JSGlobalObject* globalObject)
{
    return JSRTCDTMFToneChangeEventPrototype::create(exec->vm(), globalObject, JSRTCDTMFToneChangeEventPrototype::createStructure(exec->vm(), globalObject, JSEventPrototype::self(exec, globalObject)));
}
...
JSValue jsRTCDTMFToneChangeEventTone(ExecState* exec, JSValue slotBase, PropertyName)
{
    ...
    UNUSED_PARAM(exec);
    RTCDTMFToneChangeEvent* impl = static_cast<RTCDTMFToneChangeEvent*>(castedThis->impl());
