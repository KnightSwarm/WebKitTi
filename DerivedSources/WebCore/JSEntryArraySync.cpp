...
bool JSEntryArraySyncPrototype::getOwnPropertySlot(JSObject* object, ExecState* exec, PropertyName propertyName, PropertySlot& slot)
{
...
bool JSEntryArraySync::getOwnPropertySlot(JSObject* object, ExecState* exec, PropertyName propertyName, PropertySlot& slot)
{
...
bool JSEntryArraySync::getOwnPropertySlotByIndex(JSObject* object, ExecState* exec, unsigned index, PropertySlot& slot)
{
    JSEntryArraySync* thisObject = jsCast<JSEntryArraySync*>(object);
    ASSERT_GC_OBJECT_INHERITS(thisObject, info());
...
EncodedJSValue JSC_HOST_CALL jsEntryArraySyncPrototypeFunctionItem(ExecState* exec)
{
    ...
    if (!thisValue.inherits(JSEntryArraySync::info()))
        return throwVMTypeError(exec);
    JSEntryArraySync* castedThis = jsCast<JSEntryArraySync*>(asObject(thisValue));
    ASSERT_GC_OBJECT_INHERITS(castedThis, JSEntryArraySync::info());
    EntryArraySync* impl = static_cast<EntryArraySync*>(castedThis->impl());
...
{
    return value.inherits(JSEntryArraySync::info()) ? jsCast<JSEntryArraySync*>(asObject(value))->impl() : 0;
}
