...
{
    { "result", DontDelete | JSC::Function, (intptr_t)static_cast<NativeFunction>(jsRTCStatsResponsePrototypeFunctionResult), (intptr_t)0, NoIntrinsic },
    { "namedItem", DontDelete | JSC::Function, (intptr_t)static_cast<NativeFunction>(jsRTCStatsResponsePrototypeFunctionNamedItem), (intptr_t)0, NoIntrinsic },
    { 0, 0, 0, 0, NoIntrinsic }
};
...
JSObject* JSRTCStatsResponsePrototype::self(ExecState* exec, JSGlobalObject* globalObject)
{
    return getDOMPrototype<JSRTCStatsResponse>(exec, globalObject);
}
...
JSObject* JSRTCStatsResponse::createPrototype(ExecState* exec, JSGlobalObject* globalObject)
{
    return JSRTCStatsResponsePrototype::create(exec->vm(), globalObject, JSRTCStatsResponsePrototype::createStructure(globalObject->vm(), globalObject, globalObject->objectPrototype()));
}
...
bool JSRTCStatsResponse::getOwnPropertySlot(JSObject* object, ExecState* exec, PropertyName propertyName, PropertySlot& slot)
{
    ...
    if (canGetItemsForName(exec, static_cast<RTCStatsResponse*>(thisObject->impl()), propertyName)) {
...
EncodedJSValue JSC_HOST_CALL jsRTCStatsResponsePrototypeFunctionResult(ExecState* exec)
{
    ...
    RTCStatsResponse* impl = static_cast<RTCStatsResponse*>(castedThis->impl());
