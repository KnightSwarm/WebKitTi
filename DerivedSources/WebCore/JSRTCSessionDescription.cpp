...
{
    { "type", DontDelete, (intptr_t)static_cast<PropertySlot::GetValueFunc>(jsRTCSessionDescriptionType), (intptr_t)setJSRTCSessionDescriptionType, NoIntrinsic },
    { "sdp", DontDelete, (intptr_t)static_cast<PropertySlot::GetValueFunc>(jsRTCSessionDescriptionSdp), (intptr_t)setJSRTCSessionDescriptionSdp, NoIntrinsic },
    { "constructor", DontEnum | ReadOnly, (intptr_t)static_cast<PropertySlot::GetValueFunc>(jsRTCSessionDescriptionConstructor), (intptr_t)0, NoIntrinsic },
    { 0, 0, 0, 0, NoIntrinsic }
};
...
void JSRTCSessionDescriptionConstructor::finishCreation(ExecState* exec, JSDOMGlobalObject* globalObject)
{
    Base::finishCreation(exec->vm());
    ASSERT(inherits(info()));
    putDirect(exec->vm(), exec->propertyNames().prototype, JSRTCSessionDescriptionPrototype::self(exec, globalObject), DontDelete | ReadOnly);
...
JSObject* JSRTCSessionDescriptionPrototype::self(ExecState* exec, JSGlobalObject* globalObject)
{
    return getDOMPrototype<JSRTCSessionDescription>(exec, globalObject);
}
...
JSObject* JSRTCSessionDescription::createPrototype(ExecState* exec, JSGlobalObject* globalObject)
{
    return JSRTCSessionDescriptionPrototype::create(exec->vm(), globalObject, JSRTCSessionDescriptionPrototype::createStructure(globalObject->vm(), globalObject, globalObject->objectPrototype()));
}
...
JSValue jsRTCSessionDescriptionType(ExecState* exec, JSValue slotBase, PropertyName)
{
    ...
    UNUSED_PARAM(exec);
    RTCSessionDescription* impl = static_cast<RTCSessionDescription*>(castedThis->impl());
...
JSValue jsRTCSessionDescriptionConstructor(ExecState* exec, JSValue slotBase, PropertyName)
{
    ...
    return JSRTCSessionDescription::getConstructor(exec, domObject->globalObject());
}
...
void setJSRTCSessionDescriptionSdp(ExecState* exec, JSObject* thisObject, JSValue value)
{
    ...
    if (exec->hadException())
        return;
    impl->setSdp(nativeValue, ec);
    setDOMException(exec, ec);
}


JSValue JSRTCSessionDescription::getConstructor(ExecState* exec, JSGlobalObject* globalObject)
{
    return getDOMConstructor<JSRTCSessionDescriptionConstructor>(exec, jsCast<JSDOMGlobalObject*>(globalObject));
}
