...
{
    return JSSVGFEMorphologyElementPrototype::create(exec->vm(), globalObject, JSSVGFEMorphologyElementPrototype::createStructure(exec->vm(), globalObject, JSSVGElementPrototype::self(exec, globalObject)));
}
