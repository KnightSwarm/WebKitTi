...
{
    return JSSVGFEDisplacementMapElementPrototype::create(exec->vm(), globalObject, JSSVGFEDisplacementMapElementPrototype::createStructure(exec->vm(), globalObject, JSSVGElementPrototype::self(exec, globalObject)));
}
