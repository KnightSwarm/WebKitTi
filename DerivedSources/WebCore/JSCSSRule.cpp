...
static const HashTableValue JSCSSRuleConstructorTableValues[] =
{
    ...
    { "WEBKIT_FILTER_RULE", DontDelete | ReadOnly, (intptr_t)static_cast<PropertySlot::GetValueFunc>(jsCSSRuleWEBKIT_FILTER_RULE), (intptr_t)0, NoIntrinsic },
    { 0, 0, 0, 0, NoIntrinsic }
};
...
JSValue jsCSSRuleWEBKIT_FILTER_RULE(ExecState* exec, JSValue, PropertyName)
{
    UNUSED_PARAM(exec);
