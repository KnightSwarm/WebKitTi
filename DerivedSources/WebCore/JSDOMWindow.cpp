...
#endif
#if ENABLE(MEDIA_STREAM)
    { "LocalMediaStream", DontEnum, (intptr_t)static_cast<PropertySlot::GetValueFunc>(jsDOMWindowLocalMediaStreamConstructor), (intptr_t)setJSDOMWindowLocalMediaStreamConstructor, NoIntrinsic },
#endif
#if ENABLE(MEDIA_STREAM)
    { "webkitMediaStream", DontEnum, (intptr_t)static_cast<PropertySlot::GetValueFunc>(jsDOMWindowWebkitMediaStreamConstructor), (intptr_t)setJSDOMWindowWebkitMediaStreamConstructor, NoIntrinsic },
#endif
#if ENABLE(MEDIA_STREAM)
    { "MediaStreamEvent", DontEnum, (intptr_t)static_cast<PropertySlot::GetValueFunc>(jsDOMWindowMediaStreamEventConstructor), (intptr_t)setJSDOMWindowMediaStreamEventConstructor, NoIntrinsic },
#endif
#if ENABLE(MEDIA_STREAM)
    { "RTCIceCandidate", DontEnum, (intptr_t)static_cast<PropertySlot::GetValueFunc>(jsDOMWindowRTCIceCandidateConstructor), (intptr_t)setJSDOMWindowRTCIceCandidateConstructor, NoIntrinsic },
#endif
#if ENABLE(MEDIA_STREAM)
    { "webkitRTCPeerConnection", DontEnum, (intptr_t)static_cast<PropertySlot::GetValueFunc>(jsDOMWindowWebkitRTCPeerConnectionConstructor), (intptr_t)setJSDOMWindowWebkitRTCPeerConnectionConstructor, NoIntrinsic },
#endif
#if ENABLE(MEDIA_STREAM)
    { "RTCSessionDescription", DontEnum, (intptr_t)static_cast<PropertySlot::GetValueFunc>(jsDOMWindowRTCSessionDescriptionConstructor), (intptr_t)setJSDOMWindowRTCSessionDescriptionConstructor, NoIntrinsic },
#endif
#if ENABLE(LEGACY_NOTIFICATIONS) || ENABLE(NOTIFICATIONS)
...
#endif
#if ENABLE(PROXIMITY_EVENTS)
    { "DeviceProximityEvent", DontEnum, (intptr_t)static_cast<PropertySlot::GetValueFunc>(jsDOMWindowDeviceProximityEventConstructor), (intptr_t)setJSDOMWindowDeviceProximityEventConstructor, NoIntrinsic },
#endif
#if ENABLE(WEB_AUDIO)
...
#if ENABLE(CSP_NEXT)
    { "SecurityPolicyViolationEvent", DontEnum, (intptr_t)static_cast<PropertySlot::GetValueFunc>(jsDOMWindowSecurityPolicyViolationEventConstructor), (intptr_t)setJSDOMWindowSecurityPolicyViolationEventConstructor, NoIntrinsic },
#endif
#if ENABLE(SHADOW_DOM)
...
#endif
#if ENABLE(USER_TIMING)
    { "PerformanceMark", DontEnum, (intptr_t)static_cast<PropertySlot::GetValueFunc>(jsDOMWindowPerformanceMarkConstructor), (intptr_t)setJSDOMWindowPerformanceMarkConstructor, NoIntrinsic },
#endif
#if ENABLE(USER_TIMING)
    { "PerformanceMeasure", DontEnum, (intptr_t)static_cast<PropertySlot::GetValueFunc>(jsDOMWindowPerformanceMeasureConstructor), (intptr_t)setJSDOMWindowPerformanceMeasureConstructor, NoIntrinsic },
#endif
#if ENABLE(WEB_TIMING)
...
static const HashTable JSDOMWindowTable = { 2129, 2047, JSDOMWindowTableValues, 0 };
...
#if ENABLE(MEDIA_STREAM)
JSValue jsDOMWindowLocalMediaStreamConstructor(ExecState* exec, JSValue slotBase, PropertyName)
{
    JSDOMWindow* castedThis = jsCast<JSDOMWindow*>(asObject(slotBase));
    if (!BindingSecurity::shouldAllowAccessToDOMWindow(exec, castedThis->impl()))
        return jsUndefined();
    return JSLocalMediaStream::getConstructor(exec, castedThis);
}
...
JSValue jsDOMWindowRTCIceCandidateConstructor(ExecState* exec, JSValue slotBase, PropertyName)
{
    ...
    if (!BindingSecurity::shouldAllowAccessToDOMWindow(exec, castedThis->impl()))
        return jsUndefined();
    return JSRTCIceCandidate::getConstructor(exec, castedThis);
}
...
JSValue jsDOMWindowWebkitRTCPeerConnectionConstructor(ExecState* exec, JSValue slotBase, PropertyName)
{
    ...
    if (!BindingSecurity::shouldAllowAccessToDOMWindow(exec, castedThis->impl()))
        return jsUndefined();
    return JSRTCPeerConnection::getConstructor(exec, castedThis);
}
...
JSValue jsDOMWindowRTCSessionDescriptionConstructor(ExecState* exec, JSValue slotBase, PropertyName)
{
    ...
    if (!BindingSecurity::shouldAllowAccessToDOMWindow(exec, castedThis->impl()))
        return jsUndefined();
    return JSRTCSessionDescription::getConstructor(exec, castedThis);
}
...
#if ENABLE(CSP_NEXT)
JSValue jsDOMWindowSecurityPolicyViolationEventConstructor(ExecState* exec, JSValue slotBase, PropertyName)
{
    JSDOMWindow* castedThis = jsCast<JSDOMWindow*>(asObject(slotBase));
    if (!BindingSecurity::shouldAllowAccessToDOMWindow(exec, castedThis->impl()))
        return jsUndefined();
    return JSSecurityPolicyViolationEvent::getConstructor(exec, castedThis);
}
...
#if ENABLE(USER_TIMING)
JSValue jsDOMWindowPerformanceMarkConstructor(ExecState* exec, JSValue slotBase, PropertyName)
{
    JSDOMWindow* castedThis = jsCast<JSDOMWindow*>(asObject(slotBase));
    if (!BindingSecurity::shouldAllowAccessToDOMWindow(exec, castedThis->impl()))
        return jsUndefined();
    return JSPerformanceMark::getConstructor(exec, castedThis);
}

#endif

#if ENABLE(USER_TIMING)
JSValue jsDOMWindowPerformanceMeasureConstructor(ExecState* exec, JSValue slotBase, PropertyName)
{
    JSDOMWindow* castedThis = jsCast<JSDOMWindow*>(asObject(slotBase));
    if (!BindingSecurity::shouldAllowAccessToDOMWindow(exec, castedThis->impl()))
        return jsUndefined();
    return JSPerformanceMeasure::getConstructor(exec, castedThis);
}
...
#if ENABLE(MEDIA_STREAM)
void setJSDOMWindowLocalMediaStreamConstructor(ExecState* exec, JSObject* thisObject, JSValue value)
{
    UNUSED_PARAM(exec);
    if (!BindingSecurity::shouldAllowAccessToDOMWindow(exec, jsCast<JSDOMWindow*>(thisObject)->impl()))
        return;
    // Shadowing a built-in constructor
    jsCast<JSDOMWindow*>(thisObject)->putDirect(exec->vm(), Identifier(exec, "LocalMediaStream"), value);
}
...
void setJSDOMWindowDeviceProximityEventConstructor(ExecState* exec, JSObject* thisObject, JSValue value)
{
    ...
    if (!BindingSecurity::shouldAllowAccessToDOMWindow(exec, jsCast<JSDOMWindow*>(thisObject)->impl()))
        return;
    // Shadowing a built-in constructor
    jsCast<JSDOMWindow*>(thisObject)->putDirect(exec->vm(), Identifier(exec, "DeviceProximityEvent"), value);
}
...
#if ENABLE(CSP_NEXT)
void setJSDOMWindowSecurityPolicyViolationEventConstructor(ExecState* exec, JSObject* thisObject, JSValue value)
{
    UNUSED_PARAM(exec);
    if (!BindingSecurity::shouldAllowAccessToDOMWindow(exec, jsCast<JSDOMWindow*>(thisObject)->impl()))
        return;
    // Shadowing a built-in constructor
    jsCast<JSDOMWindow*>(thisObject)->putDirect(exec->vm(), Identifier(exec, "SecurityPolicyViolationEvent"), value);
}
...
#if ENABLE(USER_TIMING)
void setJSDOMWindowPerformanceMarkConstructor(ExecState* exec, JSObject* thisObject, JSValue value)
{
    UNUSED_PARAM(exec);
    if (!BindingSecurity::shouldAllowAccessToDOMWindow(exec, jsCast<JSDOMWindow*>(thisObject)->impl()))
        return;
    // Shadowing a built-in constructor
    jsCast<JSDOMWindow*>(thisObject)->putDirect(exec->vm(), Identifier(exec, "PerformanceMark"), value);
}

#endif

#if ENABLE(USER_TIMING)
void setJSDOMWindowPerformanceMeasureConstructor(ExecState* exec, JSObject* thisObject, JSValue value)
{
    UNUSED_PARAM(exec);
    if (!BindingSecurity::shouldAllowAccessToDOMWindow(exec, jsCast<JSDOMWindow*>(thisObject)->impl()))
        return;
    // Shadowing a built-in constructor
    jsCast<JSDOMWindow*>(thisObject)->putDirect(exec->vm(), Identifier(exec, "PerformanceMeasure"), value);
}
