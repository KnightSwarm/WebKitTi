...
{
    return JSSVGFEMergeElementPrototype::create(exec->vm(), globalObject, JSSVGFEMergeElementPrototype::createStructure(exec->vm(), globalObject, JSSVGElementPrototype::self(exec, globalObject)));
}
