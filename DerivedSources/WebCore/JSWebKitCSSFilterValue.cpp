...
static const HashTableValue JSWebKitCSSFilterValueConstructorTableValues[] =
{
    ...
    { "CSS_FILTER_CUSTOM", DontDelete | ReadOnly, (intptr_t)static_cast<PropertySlot::GetValueFunc>(jsWebKitCSSFilterValueCSS_FILTER_CUSTOM), (intptr_t)0, NoIntrinsic },
    { 0, 0, 0, 0, NoIntrinsic }
};
...
JSValue jsWebKitCSSFilterValueCSS_FILTER_CUSTOM(ExecState* exec, JSValue, PropertyName)
{
    UNUSED_PARAM(exec);
