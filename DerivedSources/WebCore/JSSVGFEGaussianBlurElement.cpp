...
{
    return JSSVGFEGaussianBlurElementPrototype::create(exec->vm(), globalObject, JSSVGFEGaussianBlurElementPrototype::createStructure(exec->vm(), globalObject, JSSVGElementPrototype::self(exec, globalObject)));
}
