...
bool JSMetadata::getOwnPropertySlot(JSObject* object, ExecState* exec, PropertyName propertyName, PropertySlot& slot)
{
...
{
    return value.inherits(JSMetadata::info()) ? jsCast<JSMetadata*>(asObject(value))->impl() : 0;
}
