...
{
    return JSSVGTitleElementPrototype::create(exec->vm(), globalObject, JSSVGTitleElementPrototype::createStructure(exec->vm(), globalObject, JSSVGElementPrototype::self(exec, globalObject)));
}
