...
{
    return JSSVGSymbolElementPrototype::create(exec->vm(), globalObject, JSSVGSymbolElementPrototype::createStructure(exec->vm(), globalObject, JSSVGElementPrototype::self(exec, globalObject)));
}
