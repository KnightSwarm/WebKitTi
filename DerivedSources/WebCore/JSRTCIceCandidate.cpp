...
{
    { "candidate", DontDelete | ReadOnly, (intptr_t)static_cast<PropertySlot::GetValueFunc>(jsRTCIceCandidateCandidate), (intptr_t)0, NoIntrinsic },
    { "sdpMid", DontDelete | ReadOnly, (intptr_t)static_cast<PropertySlot::GetValueFunc>(jsRTCIceCandidateSdpMid), (intptr_t)0, NoIntrinsic },
    { "sdpMLineIndex", DontDelete | ReadOnly, (intptr_t)static_cast<PropertySlot::GetValueFunc>(jsRTCIceCandidateSdpMLineIndex), (intptr_t)0, NoIntrinsic },
    { "constructor", DontEnum | ReadOnly, (intptr_t)static_cast<PropertySlot::GetValueFunc>(jsRTCIceCandidateConstructor), (intptr_t)0, NoIntrinsic },
    { 0, 0, 0, 0, NoIntrinsic }
};
...
void JSRTCIceCandidateConstructor::finishCreation(ExecState* exec, JSDOMGlobalObject* globalObject)
{
    Base::finishCreation(exec->vm());
    ASSERT(inherits(info()));
    putDirect(exec->vm(), exec->propertyNames().prototype, JSRTCIceCandidatePrototype::self(exec, globalObject), DontDelete | ReadOnly);
...
JSObject* JSRTCIceCandidatePrototype::self(ExecState* exec, JSGlobalObject* globalObject)
{
    return getDOMPrototype<JSRTCIceCandidate>(exec, globalObject);
}
...
JSObject* JSRTCIceCandidate::createPrototype(ExecState* exec, JSGlobalObject* globalObject)
{
    return JSRTCIceCandidatePrototype::create(exec->vm(), globalObject, JSRTCIceCandidatePrototype::createStructure(globalObject->vm(), globalObject, globalObject->objectPrototype()));
}
...
JSValue jsRTCIceCandidateCandidate(ExecState* exec, JSValue slotBase, PropertyName)
{
    ...
    UNUSED_PARAM(exec);
    RTCIceCandidate* impl = static_cast<RTCIceCandidate*>(castedThis->impl());
...
JSValue jsRTCIceCandidateConstructor(ExecState* exec, JSValue slotBase, PropertyName)
{
    ...
    return JSRTCIceCandidate::getConstructor(exec, domObject->globalObject());
}

JSValue JSRTCIceCandidate::getConstructor(ExecState* exec, JSGlobalObject* globalObject)
{
    return getDOMConstructor<JSRTCIceCandidateConstructor>(exec, jsCast<JSDOMGlobalObject*>(globalObject));
}
