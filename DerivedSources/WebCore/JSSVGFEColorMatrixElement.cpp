...
{
    return JSSVGFEColorMatrixElementPrototype::create(exec->vm(), globalObject, JSSVGFEColorMatrixElementPrototype::createStructure(exec->vm(), globalObject, JSSVGElementPrototype::self(exec, globalObject)));
}
