...
bool JSDOMFileSystem::getOwnPropertySlot(JSObject* object, ExecState* exec, PropertyName propertyName, PropertySlot& slot)
{
...
{
    return value.inherits(JSDOMFileSystem::info()) ? jsCast<JSDOMFileSystem*>(asObject(value))->impl() : 0;
}
